...
public:
    ...
    void setupUi(QDialog *VirusManagerWindow)
    {
        ...
        comboBox->setGeometry(QRect(90, 20, 72, 22));
        label_2 = new QLabel(VirusManagerWindow);
        label_2->setObjectName(QString::fromUtf8("label_2"));
        label_2->setGeometry(QRect(170, 20, 54, 12));
        comboBox_2 = new QComboBox(VirusManagerWindow);
        comboBox_2->setObjectName(QString::fromUtf8("comboBox_2"));
        comboBox_2->setGeometry(QRect(230, 20, 72, 22));
        label_3 = new QLabel(VirusManagerWindow);
        label_3->setObjectName(QString::fromUtf8("label_3"));
        label_3->setGeometry(QRect(310, 20, 54, 12));
        comboBox_3 = new QComboBox(VirusManagerWindow);
        comboBox_3->setObjectName(QString::fromUtf8("comboBox_3"));
        comboBox_3->setGeometry(QRect(370, 20, 51, 22));
        lineEdit = new QLineEdit(VirusManagerWindow);
        lineEdit->setObjectName(QString::fromUtf8("lineEdit"));
        lineEdit->setGeometry(QRect(430, 20, 91, 20));
        findVir = new QPushButton(VirusManagerWindow);
        findVir->setObjectName(QString::fromUtf8("findVir"));
        findVir->setGeometry(QRect(540, 20, 51, 20));
        pushButton_2 = new QPushButton(VirusManagerWindow);
        pushButton_2->setObjectName(QString::fromUtf8("pushButton_2"));
        pushButton_2->setGeometry(QRect(610, 20, 51, 20));
        tableWidget = new QTableWidget(VirusManagerWindow);
        tableWidget->setObjectName(QString::fromUtf8("tableWidget"));
        tableWidget->setGeometry(QRect(30, 140, 601, 201));
    ...
    void retranslateUi(QDialog *VirusManagerWindow)
    {
        ...
        findVir->setText(QCoreApplication::translate("VirusManagerWindow", "\346\237\245\346\211\276", nullptr));
